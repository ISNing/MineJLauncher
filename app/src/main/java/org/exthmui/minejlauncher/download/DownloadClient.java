 ...
 */
package org.exthmui.minejlauncher.download;
...
public interface DownloadClient {
    ...
    /**
     * Start the org.jackhuang.hmcl.download. This method has no effect if the org.jackhuang.hmcl.download already started.
     */
    void start();

    /**
     * Resume the org.jackhuang.hmcl.download. The org.jackhuang.hmcl.download will fail if the server can't fulfil the
     * partial content request and DownloadCallback.onFailure() will be called.
     * This method has no effect if the org.jackhuang.hmcl.download already started or the destination
     * file doesn't exist.
     */
    void resume();

    /**
     * Cancel the org.jackhuang.hmcl.download. This method has no effect if the org.jackhuang.hmcl.download isn't ongoing.
     */
    void cancel();
    ...
    final class Builder {
        ...
        public DownloadClient build() throws IOException {
            if (mUrl == null) {
                throw new IllegalStateException("No org.jackhuang.hmcl.download URL defined");
            } else if (mDestination == null) {
                throw new IllegalStateException("No org.jackhuang.hmcl.download destination defined");
            } else if (mCallback == null) {
                throw new IllegalStateException("No org.jackhuang.hmcl.download callback defined");
            }
