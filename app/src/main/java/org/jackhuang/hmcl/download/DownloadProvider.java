...
public interface DownloadProvider {
    ...
    /**
     * the specific version list that this org.jackhuang.hmcl.download provider provides. i.e. "forge", "liteloader", "game", "optifine"
     *
     * @param id the id of specific version list that this org.jackhuang.hmcl.download provider provides. i.e. "forge", "liteloader", "game", "optifine"
